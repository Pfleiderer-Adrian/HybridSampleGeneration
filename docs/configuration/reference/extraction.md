...
| `config.extraction.min_coverage_ratio` | `float` | `0.05` | Minimum mask coverage within a crop; range [0, 1]. |
...
| `config.extraction.roi.min_padding` | `tuple[int, ...]` | `(20, 20, 20)` | Minimum ROI padding around the anomaly on each axis. |

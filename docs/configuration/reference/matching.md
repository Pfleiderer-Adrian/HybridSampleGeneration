...
| --- | --- | --- | --- |
| `config.matching.routine` | `str` | `'batchwise'` | Candidate selection and placement method; see the matching guide. |
...
| `config.matching.batch_size` | `int` | `32` | Batch size for candidate scoring; positive. |
